...
const initialMemories: MemoryItem[] = [
  {
    ...
    mood: 'romantic',
    description: 'Full page handwritten with "Verma ji" over and over again with endless devotion...',
    story: `A deeply special page filled entirely by hand...\n\nEvery single line, every single word...\n\n"Verma ji Verma ji Verma ji..." written over and over again with endless devotion. ✍️✨\n\nWords written from the deepest corner of the heart ♡`,
    photos: ['/images/verma-ji-handwritten.jpg'],
    location: 'Handwritten with Devotion',
    favorite: true,
  },
  {
